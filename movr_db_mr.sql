...
ALTER DATABASE movr_demo SET PRIMARY REGION = "us-east1";  -- NVA
ALTER DATABASE movr_demo ADD REGION "us-east2";  -- OH
ALTER DATABASE movr_demo ADD REGION "us-west2";  -- OR
